...
var G__47375 = cljs.core.first.call(null,vals);
var G__47376 = cljs.core.rest.call(null,vals);
var G__47377 = out;
var G__47378 = cljs.core.conj.call(null,result,flappy.ai.layer_create.call(null,in$,cljs.core.first.call(null,vals)));
in$ = G__47375;
vals = G__47376;
out = G__47377;
result = G__47378;
...
var iter__4292__auto__ = (function flappy$ai$compute_per_neuron_$_iter__47379(s__47380){
return (new cljs.core.LazySeq(null,(function (){
var s__47380__$1 = s__47380;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__47380__$1);
if(temp__5457__auto__){
var s__47380__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__47380__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__47380__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__47382 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__47381 = (0);
while(true){
if((i__47381 < size__4291__auto__)){
var neuron = cljs.core._nth.call(null,c__4290__auto__,i__47381);
cljs.core.chunk_append.call(null,b__47382,flappy.ai.neuron_calculation.call(null,previous_layer_neurons,neuron));

var G__47383 = (i__47381 + (1));
i__47381 = G__47383;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__47382),flappy$ai$compute_per_neuron_$_iter__47379.call(null,cljs.core.chunk_rest.call(null,s__47380__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__47382),null);
}
} else {
var neuron = cljs.core.first.call(null,s__47380__$2);
return cljs.core.cons.call(null,flappy.ai.neuron_calculation.call(null,previous_layer_neurons,neuron),flappy$ai$compute_per_neuron_$_iter__47379.call(null,cljs.core.rest.call(null,s__47380__$2)));
}
} else {
return null;
}
...
var G__47384 = cljs.core.rest.call(null,layer);
var G__47385 = cljs.core.first.call(null,layer);
var G__47386 = cljs.core.conj.call(null,result,flappy.ai.compute_per_neuron.call(null,new cljs.core.Keyword(null,"neurons","neurons",-2094703958).cljs$core$IFn$_invoke$arity$1(input),new cljs.core.Keyword(null,"neurons","neurons",-2094703958).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,layer))));
layer = G__47384;
input = G__47385;
result = G__47386;
continue;
...
return cljs.core.update_in.call(null,network,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"weights","weights",-1097626197)], null),(function (p1__47387_SHARP_){
return cljs.core.mapv.call(null,flappy.ai.random_clamped,p1__47387_SHARP_);
}));
});
...
var G__47388 = genomes;
var G__47389 = cljs.core.rest.call(null,genome2);
var G__47390 = flappy.ai.generate_result.call(null,result,genome1,genome2);
genome1 = G__47388;
genome2 = G__47389;
result = G__47390;
continue;
...
var G__47391 = cljs.core.rest.call(null,genomes);
var G__47392 = genome2;
var G__47393 = flappy.ai.generate_result.call(null,result,genome1,genome2);
genome1 = G__47391;
genome2 = G__47392;
result = G__47393;
continue;
...
return cljs.core.conj.call(null,result,flappy.ai.generation_breed.call(null,genome1,genome2,flappy.ai.get_nb_child.call(null)));
});
...
//# sourceMappingURL=ai.js.map?rel=1555789486758
