...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__36355){
var vec__36356 = p__36355;
var _ = cljs.core.nth.call(null,vec__36356,(0),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__36359_SHARP_){
return (((p1__36359_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__36359_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__36360,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__36360;
}
});
...
var len__4499__auto___36363 = arguments.length;
var i__4500__auto___36364 = (0);
while(true){
if((i__4500__auto___36364 < len__4499__auto___36363)){
args__4502__auto__.push((arguments[i__4500__auto___36364]));

var G__36365 = (i__4500__auto___36364 + (1));
i__4500__auto___36364 = G__36365;
continue;
} else {
}
break;
...
var G__36362 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__36362,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__36362;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq36361){
...
var vec__36368 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__36368,(0),null);
var names = cljs.core.nth.call(null,vec__36368,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__36368,tag_name,names){
return (function (p1__36366_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__36366_SHARP_))){
return p1__36366_SHARP_;
} else {
return null;
}
});})(matches,vec__36368,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__36368,tag_name,names){
return (function (p1__36367_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__36367_SHARP_));
});})(matches,vec__36368,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__36371){
...
var tag = first__36374;
var content = seq__36373__$1;
...
var vec__36375 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__36375,(0),null);
var id = cljs.core.nth.call(null,vec__36375,(1),null);
var class$ = cljs.core.nth.call(null,vec__36375,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1555762421049
