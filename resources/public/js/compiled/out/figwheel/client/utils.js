...
return (new CustomEvent(event_name,(function (){var obj34083 = {"detail":data};
return obj34083;
})()));
} else {
...
var expr__34091 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
...
return console.warn(p1__34084_SHARP_);
});
...
return console.debug(p1__34085_SHARP_);
});
;})(pred__34090,expr__34091))
} else {
...
return console.error(p1__34086_SHARP_);
});
;})(pred__34090,expr__34091))
} else {
return ((function (pred__34090,expr__34091){
return (function (p1__34087_SHARP_){
return console.log(p1__34087_SHARP_);
});
;})(pred__34090,expr__34091))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34094){
...
var eval_fn = cljs.core.get.call(null,map__34095__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34097_SHARP_);
});})(new_def))
);
...
return (function (p__34098){
var vec__34099 = p__34098;
var ky = cljs.core.nth.call(null,vec__34099,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1555762782381
