...
var o38460 = temp__5455__auto__;
var temp__5455__auto____$1 = (o38460["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o38461 = temp__5455__auto____$1;
return (o38461["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37572__auto__ = f;
return (o__37572__auto__["toString"]).call(o__37572__auto__);
} else {
return "";
}
...
try{var o__37572__auto___38464 = t;
(o__37572__auto___38464["cljs$lang$ctorPrWriter"]).call(o__37572__auto___38464,t,writer);
}catch (e38463){var __38465 = e38463;
}
...
var char_code = (function (){var o__37572__auto__ = (new String(char$));
return (o__37572__auto__["charCodeAt"]).call(o__37572__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37572__auto__ = String;
return (o__37572__auto__["fromCharCode"]).call(o__37572__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38466 = num_code;
switch (G__38466) {
case (1):
return (185);
...
var o__37572__auto__ = String;
return (o__37572__auto__["fromCharCode"]).call(o__37572__auto__,superscript_code);
});
/**
...
}catch (e38468){var _e__37579__auto__ = e38468;
return false;
}})())){
...
var vec__38469 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38469,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o38472 = temp__5455__auto__;
var temp__5455__auto____$1 = (o38472["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o38473 = temp__5455__auto____$1;
return (o38473["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___38480 = arguments.length;
var i__4500__auto___38481 = (0);
while(true){
if((i__4500__auto___38481 < len__4499__auto___38480)){
args__4502__auto__.push((arguments[i__4500__auto___38481]));

var G__38482 = (i__4500__auto___38481 + (1));
i__4500__auto___38481 = G__38482;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38476){
var vec__38477 = p__38476;
var ns_detector = cljs.core.nth.call(null,vec__38477,(0),null);
...
var G__38483 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38484 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38483;
remaining_tokens = G__38484;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38474){
var G__38475 = cljs.core.first.call(null,seq38474);
var seq38474__$1 = cljs.core.next.call(null,seq38474);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38475,seq38474__$1);
});
...
var vec__38488 = cljs.core.split_with.call(null,(function (p1__38487_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38487_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38488,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38488,(1),null);
...
var vec__38491 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38491,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38491,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38494 = cljs.core.rest.call(null,remaining_tokens);
var G__38495 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38494;
name_tokens = G__38495;
continue;
} else {
...
var vec__38498 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38498,(0),null);
var arity = cljs.core.nth.call(null,vec__38498,(1),null);
var vec__38501 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38501,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38501,(1),null);
var vec__38504 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38504,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38504,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38504,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38504,(3),null);
...
var vec__38510 = result;
var munged_ns = cljs.core.nth.call(null,vec__38510,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38510,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38510,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38510,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38510,(4),null);
var arity = cljs.core.nth.call(null,vec__38510,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__38514 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__38514,(0),null);
var args = cljs.core.nth.call(null,vec__38514,(1),null);
var vec__38517 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38517,(0),null);
var name = cljs.core.nth.call(null,vec__38517,(1),null);
...
var G__38520 = (arity + (1));
var G__38521 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38522){
var vec__38523 = p__38522;
var arity = cljs.core.nth.call(null,vec__38523,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38523,(1),null);
...
return cljs.core.get.call(null,arities,p1__38526_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38527_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___38534 = arguments.length;
var i__4500__auto___38535 = (0);
while(true){
if((i__4500__auto___38535 < len__4499__auto___38534)){
args__4502__auto__.push((arguments[i__4500__auto___38535]));

var G__38536 = (i__4500__auto___38535 + (1));
i__4500__auto___38535 = G__38536;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38530){
var vec__38531 = p__38530;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38531,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38528){
var G__38529 = cljs.core.first.call(null,seq38528);
var seq38528__$1 = cljs.core.next.call(null,seq38528);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38529,seq38528__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38539__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38539__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38539__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38539__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38540 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38540,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38540,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38540,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38540,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38540,(4),null);
var arity = cljs.core.nth.call(null,vec__38540,(5),null);
...
var o__37572__auto__ = f;
return (o__37572__auto__["getBasis"]).call(o__37572__auto__);
});
/**
...
}catch (e38544){var _e__37579__auto__ = e38544;
...
var G__38545 = (obj[cljs.core.first.call(null,path)]);
var G__38546 = cljs.core.rest.call(null,path);
obj = G__38545;
path = G__38546;
continue;
} else {
...
return (function (accum,p__38547){
var vec__38548 = p__38547;
var bit = cljs.core.nth.call(null,vec__38548,(0),null);
var protocol = cljs.core.nth.call(null,vec__38548,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38551){
var vec__38552 = p__38551;
var ns = cljs.core.nth.call(null,vec__38552,(0),null);
var name = cljs.core.nth.call(null,vec__38552,(1),null);
var selector = cljs.core.nth.call(null,vec__38552,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38557,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38557,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38557,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38555_SHARP_){
return (obj[cljs.core.first.call(null,p1__38555_SHARP_)]);
});})(name,sorted_matches,vec__38557,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1555762424795
